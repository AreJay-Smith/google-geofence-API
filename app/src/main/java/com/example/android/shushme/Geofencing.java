...
/**
 * Created by Urge_Smith on 7/25/17.
 */

public class Geofencing implements ResultCallback {

    public static final String TAG = Geofencing.class.getCanonicalName();
    private static final float GEOFENCE_RADIUS = 50; // 50 meters
    private static final long GEOFENCE_TIMEOUT = 7 * 24 * 60 * 60 * 1000; // 7 weeks
    ...
    // Unregister all the Geofences created by this app from Google Play Services
 ...
 */
    ...
    private PendingIntent getGeofencePendingIntent() {
        // REsuse the PendingIntent if we already have it.
